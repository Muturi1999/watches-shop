  ...
  return (
    <div className="dashboard-root min-h-screen bg-slate-50 text-slate-900">
      <aside className="dashboard-sidebar">
        ...
        <nav className="p-4">
          <a href="/admin" className="block py-2 px-3 rounded hover:bg-slate-100">Overview</a>
          <a href="/admin/products" className="block py-2 px-3 rounded hover:bg-slate-100">Products</a>
          <a href="/admin/settings" className="block py-2 px-3 rounded hover:bg-slate-100">Settings</a>
        </nav>
